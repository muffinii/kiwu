...
red_status_label = Label(win,
        text="RED LED OFF", bg="gray", fg="white", font=("Arial", 18), width=15, height=2)
red_status_label.pack(pady=20)

green_status_label = Label(win,
        text="GREEN LED OFF", bg="gray", fg="white", font=("Arial", 18), width=15, height=2)
